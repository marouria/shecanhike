  ...
  <section id="hikes" class="pt-16 pb-24">
    <div class="max-w-7xl mx-auto px-8">
      <div class="flex flex-col items-center gap-6 mb-12">
        <button class="bg-transparent text-primary border-2 border-primary py-3 px-6 rounded text-base cursor-pointer transition-all duration-200 hover:bg-primary hover:text-white">Discover all hikes</button>
        <p class="text-center max-w-[700px] text-base leading-relaxed text-gray-900 m-0">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        <div v-for="hike in hikes" :key="hike.id" class="flex flex-col gap-4 cursor-pointer transition-transform duration-200 hover:-translate-y-1">
